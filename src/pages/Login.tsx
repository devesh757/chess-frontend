            ...
            <div className="w-full max-w-md">
                <div className="bg-[#2a2a2a] rounded-2xl border border-zinc-700/40 shadow-2xl overflow-hidden">
                    ...
                    <div className="relative px-8 pt-10 pb-6 text-center">
                        ...
                        <p className="text-zinc-400 text-sm mt-1">Log in to your Chess account</p>
                    </div>
                    ...
                    <div className="px-8 py-5 bg-[#222222] border-t border-zinc-700/30 text-center">
                        <span className="text-zinc-400 text-sm">
                            New to Chess?{" "}
                            <Link to="/register" className="text-green-500 hover:text-green-400 font-semibold hover:underline transition-colors">
                                Create an account
                            </Link>
                        </span>
                    </div>
